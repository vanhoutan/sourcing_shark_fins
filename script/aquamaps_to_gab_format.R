...
spps <- c("Alopias pelagicus", "Alopias superciliosus","Alopias vulpinus","Isurus oxyrinchus", "Isurus paucus" ,             
          "Lamna ditropis","Lamna nasus","Sphyrna corona")
...
match_raster <- read.csv('/Users/tgagne/shark_finning_2018/data/Reygondeau_dist_mods/Aetobatus narinari_OBS_MODEL.csv')
str(match_raster)
